...
export const Card = ({ character }) => {
  return (
    <>
      {
        <li className="flex flex-col gap-2 items-center h-64 justify-stretch bg-teal-700 py-4 rounded-xl border-2 border-yellow-100 shadow-xl hover:border-yellow-200 hover:scale-105 transition">
          <img
            src={character.image}
            alt={`${character.name}`}
            width="100"
